                ...
                <div class="col">
                    <address>
                        <ul class="list-unstyled">
                            <li><span class="pe-2" aria-hidden="true">✉️</span>Email: <a href="mailto:<?= EMAIL_TO ?>" aria-label="Enviar correo a <?= COMPANY_NAME ?>"> <?= EMAIL_TO ?></a></li>
                            <li><span class="pe-2" aria-hidden="true">☎️</span>Teléfono: <a href="tel:<?= COMPANY_PHONE ?>" aria-label="Llamar a <?= COMPANY_NAME ?>"> <?= COMPANY_PHONE_A11Y ?></a></li>
                        </ul>
                    </address>
                </div>
            </div>
