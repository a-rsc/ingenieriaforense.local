...
<head>
    ...
    <meta name="description" content="<?= $currentPage['content']['description'] ?>">
    ...
    <meta property="og:description" content="<?= $currentPage['content']['description'] ?>">
    ...
    <meta name="twitter:description" content="<?= $currentPage['content']['description'] ?>">
