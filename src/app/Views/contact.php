                            ...
                            <form method="post" class="contact__form" action="post" novalidate>
                                ...
                                <fieldset>
                                    ...
                                    <div class="col-md-12 text-center">
                                        <button name="submitBtn" type="submit" class="btn btn-light btn-custom"><span class="pe-3">📩</span><?= __('send_us_the_message') ?></button>
                                    </div>
                                </fieldset>
                                <!-- End Fields -->
                            </form>
                    ...
                    <section>
                        ...
                        <address>
                            <ul class="list-unstyled">
                                <li><strong><span class="pe-3">✉️</span><?= __('email') ?>:</strong> <a href="mailto:<?= $config['email']['to'] ?>" aria-label="<?= __('email_label') . $config['company.name'] ?>"> <?= $config['email']['to'] ?></a></li>
                                <li><strong><span class="pe-3">☎️</span><?= __('phone') ?>:</strong> <a href="tel:<?= $config['company']['phone'] ?>" aria-label="<?= __('phone_label') . $config['company.name'] ?>"> <?= $config['company']['phone_a11y'] ?></a></li>
                                <li><strong><span class="pe-3">📍</span><?= __('address') ?>:</strong> <?= $config['company']['address'] ?></li>
                                <li><strong><span class="pe-3">🪪</span><?= __('nif') ?>:</strong> <?= $config['company']['nif'] ?></li>
                            </ul>
                        </address>
