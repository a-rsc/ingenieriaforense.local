...
?>
        ...
        <aside class="legal-notice" style="background-color: #f4f4f4; padding: 20px; border-left: 5px solid #003366; margin-top: 40px;">
        ...
        <section class="cta" style="text-align: center; margin-top: 50px;">
            <h2>¿Necesita un análisis de viabilidad para un caso de incendio industrial?</h2>
            <a href="/contacto" class="btn-primary" style="padding: 15px 30px; background-color: #003366; color: white; text-decoration: none; border-radius: 5px;">Contactar con nuestros ingenieros forenses</a>
        </section>
<?php
    $industrialFiresPage = ob_get_clean();
?>
